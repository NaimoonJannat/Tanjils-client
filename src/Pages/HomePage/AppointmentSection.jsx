...
function AnimatedPhone() {
  ...
  return (
    <>
      <style>{`
        .ph-shell {
          position: relative; width: 216px; flex-shrink: 0;
          filter: drop-shadow(0 28px 55px rgba(0,0,0,.6));
        ...
        .ph-body {
          background:linear-gradient(160deg,#181828 0%,#1a1f3a 50%,#111827 100%);
          border-radius:38px; padding:14px 10px 18px;
        ...
        .ph-island {
          ...
          width:88px; height:26px; background:#000;
        ...
        .ph-status {
          ...
          padding:10px 16px 0; display:flex; justify-content:space-between; align-items:center; z-index:5;
        }
        ...
        /* WEBSITE */
        .ws-screen {
          padding:48px 0 0; display:flex; flex-direction:column; height:100%;
          background:linear-gradient(160deg,#0A1628 0%,#0d2040 100%);
        }
        .ws-nav {
          display:flex; align-items:center; justify-content:space-between;
          padding:0 12px 10px; border-bottom:1px solid rgba(201,169,110,.12);
        }
        ...
        .ws-hero-tag {
          ...
          border-radius:10px; padding:2px 8px; margin-bottom:8px; width:fit-content;
        }
        ...
        .ws-appt-btn {
          ...
          color:#0A1628; font-size:.55rem; font-weight:700;
        ...
        .ws-cursor {
          ...
          transition:all .65s cubic-bezier(.34,1.2,.64,1);
          filter:drop-shadow(0 2px 6px rgba(0,0,0,.5)); z-index:30;
        }
        .ws-info-strip {
        ...
        .calling-screen {
          ...
          background:linear-gradient(180deg,#0d1f0d 0%,#081420 100%);
        }
        ...
        .call-ripple:nth-child(1){inset:-10px;animation-delay:0s}
        .call-ripple:nth-child(2){inset:-22px;animation-delay:.55s}
        .call-ripple:nth-child(3){inset:-34px;animation-delay:1.1s}
        ...
        .connected-screen {
          display:flex; flex-direction:column; align-items:center;
          justify-content:center; height:100%; padding:20px;
          background:linear-gradient(180deg,#0a1f0a 0%,#081420 100%);
        }
        ...
        .confirmed-screen {
          display:flex; flex-direction:column; align-items:center;
          justify-content:center; height:100%; padding:18px;
          background:linear-gradient(160deg,#0A1628 0%,#0d2040 100%);
        }
          ...
          <div className="ph-body">
            <div className="ph-screen">
              ...
              <div className={`ph-island ${islandActive ? "active-island" : ""}`}>
                {islandActive ? (
                  <><div className="island-dot"/><div className="island-txt">{screen==="connected" ? formatTime(callTimer) : "Calling..."}</div></>
                ) : (
                  <div className="island-cam"/>
                )}
              </div>
              ...
              <div className="ph-status">
                ...
                <div style={{display:"flex",gap:3,alignItems:"center"}}>
                  <svg width="14" height="10" viewBox="0 0 14 10" fill="rgba(255,255,255,.65)">
                    <rect x="0" y="6" width="2" height="4" rx="1"/><rect x="3" y="4" width="2" height="6" rx="1"/>
                    <rect x="6" y="2" width="2" height="8" rx="1"/><rect x="9" y="0" width="2" height="10" rx="1"/>
                  </svg>
                  <svg width="22" height="10" viewBox="0 0 22 10" fill="none" style={{marginLeft:3}}>
                    <rect x="0" y="1" width="18" height="8" rx="2" stroke="rgba(255,255,255,.5)" strokeWidth="1.2"/>
                    <rect x="1.5" y="2.5" width="11" height="5" rx="1" fill="rgba(255,255,255,.7)"/>
                    <path d="M19.5 3.5v3a1.5 1.5 0 000-3z" fill="rgba(255,255,255,.4)"/>
                  </svg>
                </div>
              </div>
                ...
                <div className="ws-screen">
                  <div className="ws-nav">
                    ...
                    <div className="ws-nav-links">
                      {["Home","About","Services"].map(l=><div key={l} className="ws-nav-link">{l}</div>)}
                    </div>
                  </div>
                  <div className="ws-hero">
                    ...
                    <div style={{position:"relative",display:"inline-block"}}>
                      ...
                      {/* Animated tap cursor */}
                      <div className="ws-cursor" style={{
                        bottom: btnPressed ? "2px" : "-35px",
                        right:  btnPressed ? "6px"  : "-25px",
                        opacity: screen==="website" ? 1 : 0,
                        transform: btnPressed ? "scale(.82)" : "scale(1)",
                      }}>👆</div>
                    </div>
                  </div>
                  <div className="ws-info-strip">
                    {[["5000+","Surgeries"],["15+","Yrs Exp"],["98%","Success"]].map(([v,l])=>(
                      <div key={l} className="ws-info-item">
                        <div className="ws-info-val">{v}</div>
                        <div className="ws-info-lbl">{l}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className={`ph-sc ${screen==="calling" ? "visible" : "hidden"}`}>
                <div className="calling-screen">
                  ...
                  <div className="call-avatar-wrap">
                    <div className="call-ripple"/><div className="call-ripple"/><div className="call-ripple"/>
                    <img src="/dp.png" alt="Dr" className="call-avatar"/>
                  </div>
              ...
              <div className={`ph-sc ${screen==="connected" ? "visible" : "hidden"}`}>
                <div className="connected-screen">
                  <div className="conn-timer">{formatTime(callTimer)}</div>
              ...
              <div className={`ph-sc ${screen==="confirmed" ? "visible" : "hidden"}`}>
                <div className="confirmed-screen">
                  <div className="conf-check">
                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#C9A96E" strokeWidth="2.5">
                  ...
                  <div className="conf-card">
                    {[
                      ["👨‍⚕️","Doctor","Dr. ASM Tanjilur Rahman"],
                      ["🏥","Chamber","Faridpur Apollo Hospital"],
                      ["📅","Schedule","Sat–Wed · 4:00–8:00 PM"],
                      ["📞","Hotline","01300-263332"],
                    ].map(([icon,key,val])=>(
                      <div key={key} className="conf-row">
                        <div className="conf-icon">{icon}</div>
                        <div><div className="conf-key">{key}</div><div className="conf-val">{val}</div></div>
                      </div>
                    ))}
                  </div>
                </div>
    ...
    <>
      <style>{`
        ...
        .appt-section {
          ...
          position:relative; overflow:hidden; padding:100px 24px; font-family:'DM Sans',sans-serif;
        }
